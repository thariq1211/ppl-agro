...
<form action="{{url('cekTinggi') }}" method="post">
 ...
 <div class="radio-group">
      <input type="radio" id="rendah" name="ketinggian" value="rendah">
        <label for="rendah">Dataran Rendah</label>
      <input type="radio" id="sedang" name="ketinggian" value="sedang">
        <label for="sedang">Dataran Sedang</label>
      <input type="radio" id="tinggi" name="ketinggian" value="tinggi">
        <label for="tinggi">Dataran Tinggi</label>
  </div>
